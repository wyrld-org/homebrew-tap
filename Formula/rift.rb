...
class Rift < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/wyrld-org/homebrew-tap/releases/download/rift-v0.1.0/rift-0.1.0-darwin-arm64.tar.gz"
      sha256 "f6cf37999f7aaed9590f9af505b2afc7a6e600626db7b4daf8243c638ca3878d"
    end
    on_intel do
      url "https://github.com/wyrld-org/homebrew-tap/releases/download/rift-v0.1.0/rift-0.1.0-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/wyrld-org/homebrew-tap/releases/download/rift-v0.1.0/rift-0.1.0-linux-arm64.tar.gz"
      sha256 "7f44e34350a06ce6fdd8658a585d3ac7390f730554dcdc50f14442686b3a6f7a"
    end
    on_intel do
      url "https://github.com/wyrld-org/homebrew-tap/releases/download/rift-v0.1.0/rift-0.1.0-linux-amd64.tar.gz"
